...
sealed class OrderBy(context: Context, selection: Selection) : Filter.Sort(
    ...
    arrayOf(
        ...
        context.stringResource(MR.strings.local_filter_order_by_count),
    ),
    selection,
) {
    ...
    class ChapterCount(context: Context, selection: Selection = Selection(2, false)) : OrderBy(context, selection)
}
