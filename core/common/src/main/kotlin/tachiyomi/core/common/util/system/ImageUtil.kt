...
object ImageUtil {
    ...
    /**
     * Reads the image dimensions without loading the image into memory.
     *
     * @return (width, height) or null when the dimensions cannot be read.
     */
    fun getImageSize(imageSource: BufferedSource): Pair<Int, Int>? {
        val options = extractImageOptions(imageSource)
