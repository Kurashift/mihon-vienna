...
class WebtoonPageHolder(
    ...
    private fun notifyPageLayoutReady() {
        val decodedPage = page ?: return
        frame.doOnNextLayout {
            if (page != decodedPage) return@doOnNextLayout
            isImageLayoutReady = true
            frame.postOnAnimation {
                if (page == decodedPage) {
                    viewer.onPageImageLoaded(decodedPage)
                }
            }
        }
