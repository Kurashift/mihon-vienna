...
class WebtoonFrame(context: Context) : FrameLayout(context) {
    ...
    override fun dispatchTouchEvent(ev: MotionEvent): Boolean {
        // Disabled while the reader's first frame is being prepared, so neither the scale/fling
        // detectors nor the recycler receive touches before the content is revealed.
