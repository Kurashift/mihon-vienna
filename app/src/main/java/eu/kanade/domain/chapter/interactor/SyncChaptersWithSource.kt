    ...
    suspend fun await(
        ...
        for (sourceChapter in sourceChapters) {
            ...
            if (dbChapter == null) {
                ...
                val shouldUpdateChapter = shouldUpdateDbChapter.await(dbChapter, chapter) ||
                    (chapter.totalPages > 0L && dbChapter.totalPages != chapter.totalPages)
                if (shouldUpdateChapter) {
                    ...
                    if (chapter.totalPages > 0L) {
                        toChangeChapter = toChangeChapter.copy(totalPages = chapter.totalPages)
                    }
