...
class MangaRepositoryImpl(
    ...
    override fun getMangaProgressBySourceAsFlow(sourceId: Long): Flow<List<MangaProgressByMangaId>> {
        return database.chaptersQueries
            .getMangaProgressBySource(sourceId, MangaMapper::mapMangaProgressBySource)
            .subscribeToList()
    }

    override suspend fun getMangaProgressBySource(sourceId: Long): List<MangaProgressByMangaId> {
        return database.chaptersQueries
            .getMangaProgressBySource(sourceId, MangaMapper::mapMangaProgressBySource)
            .awaitAsList()
    }
    ...
    override suspend fun getLocalMangaIds(): List<Long> {
        return database.mangasQueries
            .getLocalMangaIds()
            .awaitAsList()
    }
    ...
    override suspend fun getMangaIdsBySourceId(sourceId: Long): Map<String, Long> {
        return database.mangasQueries
            .getMangaIdsBySourceId(sourceId) { url, id -> url to id }
            .awaitAsList()
            .toMap()
    }
