...
- The default Android build and install target is `personal` (`:app:assemblePersonal`).
- The `personal` build keeps application ID `app.mihon.dev` for in-place upgrades.
